...
namespace _3DGame
{
    public static class BoundingSphereRenderer
    {
        ...
        /// sphere.Draw(view, projection); 
        /// </remarks>
        /// <param name="gameObject">The game object to draw sphere from</param>
        /// <param name="camera">Camera instance</param>
        public static void DrawBoundingSphere(this IGameObject gameObject, Camera camera )
        {
            if (effect == null)
                throw new InvalidOperationException("You must call Initialize before you can render any spheres.");
            ...
            // update our effect matrices
            effect.World = Matrix.CreateScale(gameObject.BoundingSphere.Radius) * Matrix.CreateTranslation(gameObject.BoundingSphere.Center);
